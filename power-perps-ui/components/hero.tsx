  ...
  const cards = [
    {
      ...
      description: "Trade volatility without liquidation stress during market swings.",
    ...
    },
    {
      ...
      description: "Amplify gains exponentially with squared exposure to crypto assets.",
      ...
      <div className="container mx-auto px-4 2xl:max-w-[1400px]">
        ...
        >
          <p className="text-muted-foreground text-xl">
            Power perpetuals give traders squared exposure to crypto assets without liquidation risk. On Solana, fees are 1000x cheaper than Ethereum.
          </p>
        </motion.div>
        <motion.div
